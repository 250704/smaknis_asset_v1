<x-layouts.sbadmin>
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <a href="{{ route('kepala_sarana.sarana.histori') }}" class="btn-secondary">Lihat Histori Sarana</a>
    </div>

    <section class="panel">
        <form method="GET" action="{{ route('kepala_sarana.sarana.index') }}" class="filter-grid">
            ...
            <div>
                <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-200" for="status_sarana">Status</label>
                <select id="status_sarana" name="status_sarana" class="w-full rounded-xl border-slate-300 bg-white text-sm text-slate-800 shadow-sm focus:border-blue-500 focus:ring-blue-500/30 dark:border-white/15 dark:bg-slate-900/60 dark:text-slate-100 dark:focus:border-cyan-400 dark:focus:ring-cyan-400/40">
            ...
            <div class="filter-actions">
                ...
                <a href="{{ route('kepala_sarana.sarana.index') }}" class="btn-secondary">Reset</a>
            </div>
        </form>
    </section>
                ...
                <tbody class="bg-transparent divide-y divide-slate-100 dark:divide-white/5">
                    @forelse ($sarana as $item)
                        <tr>
                            ...
                            <td class="px-4 py-3">
                                <a href="{{ route('kepala_sarana.sarana.show', $item) }}"
