<x-layouts.sbadmin>
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <a href="{{ route('kepala_sarana.aset.index') }}" class="btn-secondary">Kembali ke Data Sarana</a>
    </div>

    <section class="panel">
        <form method="GET" action="{{ route('kepala_sarana.aset.histori') }}" class="filter-grid">
