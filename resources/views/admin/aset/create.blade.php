<x-layouts.sbadmin>
    ...
    <div class="grid gap-6 md:grid-cols-2">
        ...
        <a href="{{ route('admin.aset.create-unit') }}" class="group panel overflow-hidden p-0 transition-all duration-200 hover:shadow-lg hover:-translate-y-1">
        ...
        {{-- Card 2: Input Massal --}}
        <a href="{{ route('admin.aset.import-massal.create') }}" class="group panel overflow-hidden p-0 transition-all duration-200 hover:shadow-lg hover:-translate-y-1">
